...
contract L2Registry is ERC721, L2Resolver, IL2Registry, RegistrarControl {
  ...
  /// @notice Emitted when name owner changes
  ///
  /// @param node The namehash of the transfered subdomain.
  ...
  function _isExpired(bytes32 node) internal view override returns (bool) {
  ...
  function ownerOf(
    uint256 tokenId
  ) public view override(ERC721, IL2Registry) returns (address) {
